...
PageManager.prototype.handleAtBat = function(evt) {
	evt.preventDefault();
...
// an at bat
//
PageManager.prototype.atBat = function(battingAverage, strikePercentage) {
	var balls = 0;
	var strikes = 0;
	var hit = false;
	var isBatting = true;
...
// }
//
PageManager.prototype.throwPitch = function(battingAverage, strikePercentage) {
	var outcome = {
		isStrike: false,
		isBall: false,
		isHit: false,
...
PageManager.prototype.logCount = function(balls, strikes) {
	return console.log(
		"The count is {balls} and {strikes}".supplant({
			"balls": balls,
			"strikes": strikes
		})
	);
